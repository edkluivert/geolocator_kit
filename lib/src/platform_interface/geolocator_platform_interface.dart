...
abstract class GeolocatorPlatform extends PlatformInterface {
  ...
  static GeolocatorPlatform _instance = GeolocatorFfi();

  /// The default instance of [GeolocatorPlatform] to use.
  ///
  /// Defaults to [GeolocatorFfi].
  ...
  ///
  /// An instance of [ServiceStatus] will be emitted each time the
  ...
  /// `accuracy` of [LocationSettings] (defaults to "best"). The
  /// `distanceFilter` controls the minimum distance the device needs to move
  /// before the update is emitted (default value is 0 indicator no filter is
  /// used). On Android you can force the use of the Android LocationManager
  /// instead of the FusedLocationProvider by setting the `forceLocationManager`
  ...
  double bearingBetween(
    ...
    var startLongitudeRadians = _toRadians(startLongitude);
    var startLatitudeRadians = _toRadians(startLatitude);
    var endLongitudeRadians = _toRadians(endLongitude);
    var endLatitudeRadians = _toRadians(endLatitude);
