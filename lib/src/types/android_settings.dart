...
class AndroidSettings extends LocationSettings {
  /// Initializes a new [AndroidSettings] instance with default values.
  ///
  ...
  /// background service package that will start a new engine that is not tied to your main activity.
